...
<head>
    ...
    <title>Cloud Art Gallery - Add Product</title>
</head>
<body>
    <!-- NAVBAR -->
    <nav>
        <a href="admin-panel.html" class="brand">
            <p>Cloud Art Gallery</p>
        </a>
        <ul class="nav-menu">
                ...
                <form method="post" action="add-products.php" enctype="multipart/form-data">
                    ...
                    <div class="input-box">
                        ...
                        <select name="category" required>
                            ...
                            <option value="traditional">Traditional Nepali Art</option>
                            <option value="paintings">Paintings</option>
                            <option value="photo">Photography Collections</option>
                        </select>
                    </div>
